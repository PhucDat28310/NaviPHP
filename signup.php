      ...
      <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-primary">
              ...
              <form role="form" method="post" action="signupCheck.php" onsubmit="return matchpassword()">
                  ...
                  <div class="row">
                      <div class="form-group col-xs-12">
                      <label for="username"><span class="text-danger" style="margin-right:5px;">*</span>Xác nhận</label>
                          <div class="input-group">
                  ...
                  <div class="row">
                      <div class="form-group col-xs-12">
                      <label for="username"><span class="text-danger" style="margin-right:5px;">*</span>Số điện thoại</label>
                          <div class="input-group">
                  ...
                  <div class="row">
                      <div class="form-group col-xs-12">
                      <label for="username"><span class="text-danger" style="margin-right:5px;">*</span>Địa chỉ</label>
                          <div class="input-group">
                  ...
                  <div class="row">
                      <div class="form-group col-xs-10">
                          <a href="index.php">Nếu bạn là quản trị viên. Ấn vào đây.</a><br>
                          <a href="login.php">Đã có tài khoản? Ấn vào đây.</a>
                      </div>
                  </div>
              </form>
          </div>
