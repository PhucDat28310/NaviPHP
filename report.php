    ...
    <div class="container-fluid row section">
            <div class ="col-md-3 sidebar">
                 <ul class="nav nav-pills nav-stacked">
                     <li role="presentation"><a href="admin.php">Bảng điều khiển</a></li>
                     <li role="presentation"><a href="doner.php">Thêm nhà tài trợ</a></li>
                     <li role="presentation"><a href="list.php">Danh sách chờ</a></li>
                </ul>
            </div>
              ...
              if(isset($_SESSION['form']) && !empty($_SESSION['form'])){
               ...
               ?>
                ...
                <table  id="example" class="table table-striped">
                  ...
                  <p>
                    Tổng số tiền = <b><?php echo $total; ?></b> VND.
                  </p>
